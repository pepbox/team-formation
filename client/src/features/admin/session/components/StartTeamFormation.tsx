  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full sm:w-auto"
      />
      <button
      ...
      <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-2">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:gap-3 sm:justify-end">
          ...
          className="px-4 py-2 text-gray-600 border cursor-pointer border-gray-300 rounded-lg hover:bg-gray-50 w-full sm:w-auto"
          >
          Cancel
          </button>
          <button
          ...
          disabled={isLoading}
          className="px-4 py-2 bg-[#111111] text-white cursor-pointer rounded-lg hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed w-full sm:w-auto"
          >
